        ...
        "ingredients": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "name": {"type": "string", "minLength": 1, "description": "название ингредиента на русском — никогда не пустое"},
...
async def structure_recipe(raw_text: str, video_title: str, ingredient_catalog_text: str) -> dict:
    system = (
        ...
        "name заполняй ВСЕГДА конкретным русским названием продукта (как он назван в тексте) — никогда не оставляй пустым и не пиши общие слова "
        "вроде «ингредиент»/«продукт».\n"
